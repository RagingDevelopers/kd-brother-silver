        ...
        <div class="navbar-nav flex-row order-md-last me-5 ">
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
                    <span class="avatar avatar-sm" style="background-image: url(<?=base_url("assets")?>/man.png)"></span>
                    <div class="d-none d-xl-block ps-2">
                        <div><?= ucfirst($this->session->userdata('admin_login')['name'] ?? "") ?></div>
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                    ...
                    <a href="" class="dropdown-item" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-original-title="Change Password">
                        <i class="fs-2 ti ti-key dropdown-item-icon "></i>
                        Change Password
                    </a>
                    <a href="https://pani.shreejiset.com/admin/logout" class="dropdown-item" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-original-title="Logout">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon dropdown-item-icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
