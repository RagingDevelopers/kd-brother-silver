		...
		<div class="row mt-3">
			...
			<div class="col-md-8">
				<div class="bill-title row" style="padding-left: 0; padding-right: 0; margin-left: 0px; margin-right: 0px;">
					...
					<div class="col-md-4" style="text-align:center;"><strong>Purchase Estimate</strong></div>
						...
						<table width="100%" class="bill-table table">
							...
							<tbody>
								...
								<?php foreach ($bill_data as $v) {
									...
									$totalFineWt += $v['fine_gold'];
									$totalAmount += $v['net_amt']; ?>

									<tr>
										<td><?= $i++; ?></td>
										<td><?= $v['item_name'] ?></td>
										<td class="right"><?= $v['pcs'] ?></td>
										<td class="right"><?= $v['touch'] ?></td>
										<td class="right"><?= $v['gross_weight'] ?></td>
										<td class="right"><?= $v['less_weight'] ?></td>
										<td class="right"><?= $v['net_weight'] ?></td>
										<td class="right"><?= $v['fine_gold'] ?></td>
										<td class="right"><?= $v['net_amt'] ?></td>
									</tr>
