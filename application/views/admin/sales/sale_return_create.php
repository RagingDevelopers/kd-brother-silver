						...
						<div class="row ms-1">
							<div class="col-md-2">
								<div class="form-group">
									...
									<input type="date" name="date" class="form-control from" id="date" value="<?php if (isset($data['date'])) {echo $data['date'];} else {echo date('Y-m-d');} ?>" />
								</div>
							</div>
							<div class="col-md-2">
								<div class="form-group">
												...
												foreach ($data['sale_detail'] as $row) { ?>
													...
													<tr class="main-row">
														...
														<td>
															<select class="form-select select2 item" required name="item[]">
																...
																<?php foreach ($item as $i) { ?>
																	<option value="<?= $i['id']; ?>" <?php if (isset($row['item_id']) && $i['id'] == $row['item_id']) {echo 'selected';} ?>> <?= $i['name']; ?>
																	</option>
																<?php } ?>
															</select>
														</td>
														...
														<td><select name="labour_type[]"  class="form-control w65 labour_type">
																...
																<option value="net" <?php if ($row['labour_type'] == 'net') {echo 'selected';} ?>>Net</option>
																<option value="pcs" <?php if ($row['labour_type'] == 'pcs') {echo 'selected';} ?>>Pcs</option>
																<option value="fixed" <?php if ($row['labour_type'] == 'fixed') {echo 'selected';} ?>>Fixed</option>
																<option value="gross" <?php if ($row['labour_type'] == 'gross') {echo 'selected';} ?>>Gross</option>
															</select>
														</td>
									...
									<select class="form-select select2 row_material">
										...
										if (!empty($row_material)) {
											foreach ($row_material as $rm) { ?>
												<option value="<?= $rm['id']; ?>" <?php if (isset($row) && $rm['id'] == $row['row_material_id']) {echo 'selected';} ?>><?= $rm['name']; ?></option>
										<?php }
										} ?>
									</select>
								</td>
