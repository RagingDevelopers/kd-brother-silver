...
<div class="row element">
	<div class="col-sm-12">
		<div class="card">
			<form action="<?= (isset($data)) ? base_url("sales_return/update/{$data['id']}") : base_url('sales_return/store') ?>" method="post" class="main-form" novalidate>
											...
											<tbody class="paste append-here">
												...
												foreach ($data['sale_detail'] as $row) { ?>
													...
													<tr class="main-row">
														...
														<td><input type="text" class="form-control inputBox net_weight readonly" name="net_weight[]" step="any" readonly placeholder="Net Weight" value="<?= $row['net_weight'] ?? null ?>"></td>
														<td><input type="text" class="form-control inputBox touchPreData" name="pre_touch[]" step="any" placeholder="Pre Touch" value="<?= $row['pre_touch'] ?? null ?>"></td>
														...
														<td><input type="number" step="any" class="form-control labour inputBox" name="labour[]" step="any" placeholder="Labour Amount" value="<?= $row['labour'] ?? null; ?>" /></td>
														...
														<td><input type="text" step="any" class="form-control sub_total inputBox100" name="sub_total[]" placeholder="Sub Total" value="<?= $row['sub_total'] ?? 0 ?>"></td>
														<td>
				...
				<div class="row mainRow" style="margin-top:1%;">
					...
					<div class="col-md-1 allinone dratecutrs">
						<div class="form-group">
							...
							<input type="text" name="amount" class="form-control" id="amount" value="" step="any" placeholder="amount" />
						</div>
					</div>
