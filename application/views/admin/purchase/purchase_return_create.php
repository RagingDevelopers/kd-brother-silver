...
<div class="row element">
	<div class="col-sm-12">
		<div class="card">
			<form action="<?= (isset($data)) ? base_url("purchase_return/update/{$data['id']}") : base_url('purchase_return/store') ?>" method="post" class="main-form" novalidate>
				...
				<div class="card-header">
					...
					<h1 class="card-title"><b> Purchase Return </b></h1>
				</div>
				<div class="card-body border-bottom py-3">
					<div class="col-md-12 mb-5 ">
						<div class="row ms-1">
							...
							<div class="card mt-5">
								<div class="row">
									<div class="table-responsive scrollTable" style="max-height: 350px; overflow-y: scroll;">
...
<script class="javascript">
	...
	function scrollToBottom() {
		var $tableContainer = $('.scrollTable');
