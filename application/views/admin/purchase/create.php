											...
											<tbody class="paste append-here">
												...
												foreach ($data['purchase_detail'] as $row) { ?>
													...
													<tr class="main-row">
														...
														<td>
															<input type="text" class="form-control gross_weight inputBox" name="gross_weight[]" placeholder="Gross Weight" step="any" value="<?= $row['gross_weight'] ?? null ?>">
														</td>
														<td>
															<input type="hidden" name="raw_material_data[]" value="<?= $row['raw_material_data'] ?? null; ?>" class="form-control rmdata" placeholder="Enter Weight" autocomplete="off">
															<div class="d-flex gap-2">
																<input type="text" class="form-control inputBox less_weight" name="less_weight[]" placeholder="Less Weight" step="any" value="<?= $row['less_weight'] ?? null ?>">
