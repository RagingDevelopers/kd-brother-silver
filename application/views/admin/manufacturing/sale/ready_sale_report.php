		...
		<div class="col-12">
			<div class="card">
				...
				<div class="card-header justify-content-between">
					...
					<a class="btn btn-action bg-primary text-white m-1 p-3" href="<?= base_url(); ?>manufacturing/ready_for_sale/create">
	...
	$(document).ready(function() {
		...
		$(document).on("click", "#search", function(e) {
			...
			data = {
				...
				"group": groupBy,
				"url": "manufacturing/ready_for_sale",
			}

			$.ajax({
				showLoader: true,
				url: "<?= base_url('/manufacturing/ready_for_sale/getReport'); ?>",
				timeout: 8000,
				type: "POST",
				processData: true,
				data: data,
