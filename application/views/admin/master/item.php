	...
	<div class="col-sm-12">
		<div class="card">
			...
			<div class="card-body border-bottom py-3">
				<div class="col-md-12">
					<div class="row ms-1">
						<form class="row" action="<?= (isset($update)) ? base_url("master/item/index/update/{$update['id']}") : base_url('master/item/index/store') ?>" method="post">

							<div class="row">
								<div class="col-sm-3">
									<label class="form-label" for="prd"> Name: </label>
									<input class="form-control" type="text" name="name" placeholder="Enter item Name" value="<?= $update['name'] ?? null ?>" id="name" required>
						...
						<tbody>
							...
							?>
									<tr>
										...
										<td>
											<div>
												<a class="btn btn-action bg-success text-white me-2" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Edit" href="<?= base_url('master/item/edit/') . $data['id'] ?>">
