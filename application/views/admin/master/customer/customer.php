                                            ...
                                            if (!empty($update)) {
                                                ...
                                                foreach ($items as $row) { ?>
                                                    <tr class="sectiontocopy">
                                                        ...
                                                        <td>
                                                            <input class="form-control extra_touch" type="number" name="extra_touch[]" placeholder="Enter Extra touch  Name" value="<?= $row['extra_touch'] ?? null ?>" id="extra_touch" required>
                                                        </td>
                                                        <td>
                                                ...
                                                <tr class="sectiontocopy">
                                                    ...
                                                    <td>
                                                        <input class="form-control extra_touch" type="number" name="extra_touch[]" placeholder="Enter Extra touch  Name" value="" id="extra_touch" required>
                                                    </td>
                                                    <td>
                                                        <input class="form-control wastage" type="number" name="wastage[]" placeholder="Enter Wastage Amount" value="" id="wastage" required>
                                                    </td>
                                                    <td>
                                                        <select class="form-select select2 label" name="label[]">
                                                            <option selected value="">Select Label</option>
                                                    ...
                                                    <td>
                                                        <input class="form-control rate" type="number" name="rate[]" placeholder="Enter Rate Amount" value="" id="rate" required>
                                                    </td>
                                                    <td>
                                                        <input class="form-control sub_total" type="number" name="sub_total" placeholder="Subtotal" id="sub_total" value="" required readonly>
                                                    </td>
                                                    <td>
                                                        <button type="button" class="btn btn-danger del">X</button>
                                                    </td>
