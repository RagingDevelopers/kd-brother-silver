                        ...
                        <form class="row"
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <select class="form-select select2" id="opening_amount_type"
                                            ...
                                            if (!empty($update)) {
                                                ...
                                                foreach ($items as $row) { ?>
                                                    <tr class="sectiontocopy">
                                                        ...
                                                        <td>
                                                            <input class="form-control extra_touch" type="number"
                                                                name="extra_touch[]" placeholder="Enter Extra touch  Name"
                                                                value="<?= $row['extra_touch'] ?? null ?>" id="extra_touch"
                                                                required>
                                                        </td>
                                                        <td>
                                                            <input class="form-control wastage" type="number" name="wastage[]"
                                                        ...
                                                        <td>
                                                            <input class="form-control sub_total" type="number"
                                                                name="sub_total[]" placeholder="Subtotal" id="sub_total"
                                                                value="<?= $row['sub_total'] ?? null ?>" required readonly>
                                                        </td>
                                                        <td>
                                                ...
                                                <tr class="sectiontocopy">
                                                    ...
                                                    <td>
                                                        <input class="form-control wastage" type="number" name="wastage[]"
                                                            placeholder="Enter Wastage Amount" value="" required>
                                                    </td>
                                                    <td>
                                                        <select class="form-select select2 label" name="label[]">
                                                            <option selected value="">Select Label</option>
                                                    ...
                                                    <td>
                                                        <input class="form-control rate" type="number" name="rate[]"
                                                            placeholder="Enter Rate Amount" value="" id="rate" required>
                                                    </td>
                                                    <td>
                                                        <input class="form-control sub_total" type="number" name="sub_total"
                                                            placeholder="Subtotal" id="sub_total" value="" required
                                                            readonly>
                                                    </td>
                                                    <td>
                                                        <button type="button" class="btn btn-danger del">X</button>
