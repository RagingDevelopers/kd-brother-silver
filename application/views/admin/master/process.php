                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                    ...
                                    <select class="form-select select2 " name="finished_good" id="finished_good">
                                        <option value="Yes" <?php if (isset($update) && $update['finished_good'] == 'Yes') {
                                                                echo 'selected';
                                                            } ?>>Yes</option>
                                        <option value="No" <?php if (isset($update) && $update['finished_good'] == 'No') {
                                                                echo 'selected';
                                                            } ?>>No</option>
                                    </select>
                                </div>
                                <div class="col-sm-2">
                                    ...
                                    <select class="form-select select2 " name="labour_type" id="labour_type">
                                        ...
                                        <option value="PCS" <?php if (isset($update) && $update['labour_type'] == 'PCS') {
                                                                echo 'selected';
                                                            } ?>>PCS</option>
                                        <option value="WEIGHT" <?php if (isset($update) && $update['labour_type'] == 'WEIGHT') {
                                                                    echo 'selected';
                                                                } ?>>WEIGHT</option>
                                        <option value="BOTH" <?php if (isset($update) && $update['labour_type'] == 'BOTH') {
                                                                    echo 'selected';
                                                                } ?>>BOTH</option>
                                    </select>
                                </div>
                                <div class="col-sm-2">
                                    ...
                                    <select class="form-select select2 " name="show_or_not" id="show_or_not">
                                        ...
                                        <option value="YES" <?php if (isset($update) && $update['show_or_not'] == 'YES') {
                                                                echo 'selected';
                                                            } ?>>YES</option>
                                        <option value="NO" <?php if (isset($update) && $update['show_or_not'] == 'NO') {
                                                                echo 'selected';
                                                            } ?>>NO</option>
                                    </select>
                                </div>
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" name="autofill_given_touch" id="autofillTouch">
                                            ...
                                            <option value="YES" <?php if (isset($update) && $update['autofill_given_touch'] == 'YES') {
                                                                    echo 'selected';
                                                                } ?>>YES</option>
                                            <option value="NO" <?php if (isset($update) && $update['autofill_given_touch'] == 'NO') {
                                                                    echo 'selected';
                                                                } ?>>NO</option>
                                        </select>
                                    </div>
