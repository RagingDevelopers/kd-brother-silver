            ...
            <div class="card-body border-bottom py-3">
                <div class="row ms-5">
                    <form class="row" action="<?php if (isset($update_data)) {
                        echo base_url('master/Process/index/update');
                    } else {
                        echo base_url('master/Process/index/add');
                    } ?>" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 ms-4">
                                ...
                                <input class="btn btn-primary " type="submit"
                                    value="<?= isset($update_data) ? "UPDATE" : "ADD" ?> PROCESS">
                            </div>
                        </div>
                    </form>
                </div>
                                            ...
                                            <div>
                                                ...
                                                <a class="btn btn-primary"
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                        class="icon icon-tabler icon-tabler-edit " width="50" height="50"
                                                ...
                                                <a class="btn btn-danger"
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                        class="icon icon-tabler icon-tabler-trash-off" width="24" height="24"
