    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                ...
                <h1 class="card-title"><b> Category </b></h1>
            </div>
            <div class="card-body border-bottom py-3">
                <div class="col-md-12 mb-5 ">
                    <div class="row ms-1">
                        <form class="row"
                            action="<?= (isset($update)) ? base_url("master/category/index/update/{$update['id']}") : base_url('master/category/index/store') ?>"
                            method="post">
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    ...
                                    <input class="form-control" type="text" name="name"
                                        placeholder="Enter category Name" value="<?= $update['name'] ?? null ?>"
                                        id="name" required>
