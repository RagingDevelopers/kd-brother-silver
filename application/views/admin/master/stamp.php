    ...
    <div class="col-sm-12">
        <div class="card  card-link card-link-pop">
            <div class="card-header">
                ...
                <h1 class="card-title"><b> Stamp </b></h1>
            </div>
            <div class="card-body border-bottom py-3">
                <div class="col-md-12 mb-5 ">
                    <div class="row ms-1">
                        <form class="row" action="<?= (isset($update)) ? base_url("master/stamp/index/update/{$update['id']}") : base_url('master/stamp/index/store') ?>" method="post">
                            <div class="row">
                                <div class="col-sm-3">
                                    <label class="form-label" for="prd"> Name: </label>
                                    <input class="form-control" type="text" name="name" placeholder="Enter stamp Name" value="<?= $update['name'] ?? null ?>" id="name">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <div>
                                                        <a class="btn  btn-success btn-icon rounded-circle text-white me-2" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Edit bank" href="<?= base_url('master/stamp/edit/') . $data['id'] ?>">
